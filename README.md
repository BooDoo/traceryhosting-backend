These instructions assume you've already set up the front end side of this: if not, get you to `https://github.com/BooDoo/traceryhosting-frontend` and at least read the README there.
